...
class TestProjectAllFiles:
    ...
    def test_with_mock(self, monkeypatch, empty_directory):
        ...
        """
        mock_all_files = mock.create_autospec(all_files)
        mock_all_files.return_value = "foo"
        monkeypatch.setattr("reuse.project.all_files", mock_all_files)
    ...
    def test_with_mock_implicit_dir(self, monkeypatch, empty_directory):
        """If no argument is given to Project.all_files, project.root is
        implied.
        """
        mock_all_files = mock.create_autospec(all_files)
        mock_all_files.return_value = "foo"
